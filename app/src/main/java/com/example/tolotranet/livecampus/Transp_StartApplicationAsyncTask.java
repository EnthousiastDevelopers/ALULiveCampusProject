...
public class Transp_StartApplicationAsyncTask extends AsyncTask<Activity, Void, Void> {
	...
	protected Void doInBackground(Activity... arg0) {
		...
		File myfile = new File(Dir, "Transp.txt");
	...
	protected void onPostExecute(Void result) {
		...
		if (FileExists == true) {
			...
			Intent i = new Intent();
			i.setClass(myActivity.getApplicationContext(), Transp_TransApp.class);
