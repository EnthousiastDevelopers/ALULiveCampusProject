...
public class Settings_MyCustomBaseAdapter extends BaseAdapter {
	private static ArrayList<Settings_ItemObject> MyArrayObjects = new ArrayList<Settings_ItemObject>();
	private static ArrayList<Settings_ItemObject> FilteredObjects = new ArrayList<Settings_ItemObject>();
	private Context context;
	private LayoutInflater mInflater;
	private ItemFilter myFilter = new ItemFilter();

	public Settings_MyCustomBaseAdapter(Context c, ArrayList<Settings_ItemObject> MyList) {
		this.context = c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = mInflater.inflate(R.layout.settings_list_item_single, null);
	...
	private class ItemFilter extends Filter {
		...
		protected FilterResults performFiltering(CharSequence arg0) {
			...
			if(arg0 == null || arg0.length() == 0){
				...
				final ArrayList<Settings_ItemObject> TempList = new ArrayList<Settings_ItemObject>();
				for(Settings_ItemObject ItemObject : MyArrayObjects){
		...
		protected void publishResults(CharSequence arg0, FilterResults arg1) {
			// TODO Auto-generated method stub
			FilteredObjects = (ArrayList<Settings_ItemObject>) arg1.values;
