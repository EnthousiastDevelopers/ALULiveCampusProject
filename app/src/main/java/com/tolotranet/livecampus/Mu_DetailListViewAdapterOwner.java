...
public class Mu_DetailListViewAdapterOwner extends BaseAdapter {

	private static ArrayList<Mu_DetailListItem> DetailList;
	private LayoutInflater mInflater;

	public Mu_DetailListViewAdapterOwner(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.mu_detail_list_item_owner, null);
