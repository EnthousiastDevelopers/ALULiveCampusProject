...
public class Maint_startApplicationAsyncTask extends AsyncTask<Activity, Void, Void> {
    ...
    protected Void doInBackground(Activity... arg0) {
        ...
        File myfile = new File(Dir, "Maint.txt");
    ...
    protected void onPostExecute(Void result) {
        ...
        if (FileExists == true) {
            ...
            Intent i = new Intent();
            i.setClass(myActivity.getApplicationContext(), Maint_MainList.class);
