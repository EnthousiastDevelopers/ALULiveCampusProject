...
public class Interaction_GetDataAsyncTask extends AsyncTask<Activity, Void, Void> {

    Activity myActivity;
    private String origin = null;

    public Interaction_GetDataAsyncTask(String origin) {
        this.origin = origin;
    }
    ...
    protected Void doInBackground(Activity... arg0) {
        ...
        try {
            String xmlString = Interaction_XMLCreator.CreateSpreadSheetToXML();
            Interaction_FileOperations.StoreData(xmlString);
    ...
    private void getData() throws AuthenticationException,
        ...
        for (ListEntry row : listFeed.getEntries()) {
            for (String tag : row.getCustomElements().getTags()) {
                ...
                //end of real columns the rest should be null
        ...
        Interaction_XMLParserClass.q1 = q1;
        Interaction_XMLParserClass.q2 = q2;
        Interaction_XMLParserClass.q3 = q3;
        Interaction_XMLParserClass.q4 = q4;
        Interaction_XMLParserClass.q5 = q5;
        Interaction_XMLParserClass.q6 = q6;
        Interaction_XMLParserClass.q7 = q7;
        Interaction_XMLParserClass.q8 = q8;
        Interaction_XMLParserClass.q9 = q9;
        Interaction_XMLParserClass.q10 = q10;
        Interaction_XMLParserClass.q11 = q11;
        Interaction_XMLParserClass.q12 = q12;
        Interaction_XMLParserClass.q13 = q13;
        Interaction_XMLParserClass.q14 = q14;
        Interaction_XMLParserClass.Tag_Array = Tag_Array;
