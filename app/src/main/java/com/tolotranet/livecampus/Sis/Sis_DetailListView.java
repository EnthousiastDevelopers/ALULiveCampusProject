...
public class Sis_DetailListView extends Activity {
    ...
    private TextView cy;
    private ListView lv;
    private Sis_DetailListViewAdapter myPersonDetailListViewAdapter;
    private ArrayList<Sis_DetailListItem> DetailList;
    private ProgressDialog mProgress;
    private Button interactBnt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipientEmail = Sis_XMLParserClass.q2.get(Index);
        ...
        interactBnt = (Button) findViewById(R.id.interactBtn);
        interactBnt.setOnClickListener(new InteractOnClickListener());
...
//		}
    ...
    private class InteractOnClickListener implements View.OnClickListener {
        @Override
        public void onClick(View v) {
            Intent i = new Intent(Sis_DetailListView.this, Interact_MainActivity.class);
