...
public class Interaction_XMLParserClass {
	...
	public Interaction_XMLParserClass() throws XmlPullParserException,
			IOException {
...
//		int eventType = xrp.getEventType();
		...
		String xmlString = Interaction_FileOperations.ReadData();
