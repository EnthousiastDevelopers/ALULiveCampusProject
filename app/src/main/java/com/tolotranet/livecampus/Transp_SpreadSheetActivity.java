...
public class Transp_SpreadSheetActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mProgress.show();
		setContentView(R.layout.transp_activity_spread_sheet);

		Transp_StartApplicationAsyncTask myTask = new Transp_StartApplicationAsyncTask();
		myTask.execute(this);
	}
