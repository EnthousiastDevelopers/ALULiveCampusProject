...
public class Faq_MyCustomBaseAdapter extends BaseAdapter {
	private static ArrayList<Faq_ItemObject> MyArrayObjects = new ArrayList<Faq_ItemObject>();
	private static ArrayList<Faq_ItemObject> FilteredObjects = new ArrayList<Faq_ItemObject>();
	private Context context;
	private LayoutInflater mInflater;
	private ItemFilter myFilter = new ItemFilter();


	public Faq_MyCustomBaseAdapter(Context c, ArrayList<Faq_ItemObject> MyList) {
		this.context = c;
	...
	private class ItemFilter extends Filter {
		...
		protected FilterResults performFiltering(CharSequence arg0) {
			...
			if(arg0 == null || arg0.length() == 0){
				...
				final ArrayList<Faq_ItemObject> TempList = new ArrayList<Faq_ItemObject>();
				for(Faq_ItemObject Sis_ItemObject : MyArrayObjects){
		...
		protected void publishResults(CharSequence arg0, FilterResults arg1) {
			// TODO Auto-generated method stub
			FilteredObjects = (ArrayList<Faq_ItemObject>) arg1.values;
