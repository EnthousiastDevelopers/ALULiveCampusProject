...
public class Maint_DetailListViewOwner extends Activity
		implements EasyPermissions.PermissionCallbacks {

	ListView lv;
	Maint_DetailListViewAdapterOwner myPersonDetailListViewAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myPersonDetailListViewAdapter = new Maint_DetailListViewAdapterOwner(this,
				DetailList);
	...
	private ArrayList<Maint_DetailListItem> getPersonalDetails(int Index) {
		...
		if (!(Maint_XMLParserClass.q2.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q2.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
		DetailList.add(sr);
		map.put(tag, Maint_XMLParserClass.q2.get(Index));


			tag = "firstname";
			sr = new Maint_DetailListItem();
			sr.setDetailName(tag);
		if (!(Maint_XMLParserClass.q3.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q3.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q3.get(Index));


			tag = "lastname";
			sr = new Maint_DetailListItem();
			sr.setDetailName("lastname");
		if (!(Maint_XMLParserClass.q4.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q4.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q4.get(Index));

			tag = "fullname";
			sr = new Maint_DetailListItem();
			sr.setDetailName("fullname");
		if (!(Maint_XMLParserClass.q5.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q5.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q5.get(Index));


			tag = "birthday";
			sr = new Maint_DetailListItem();
			sr.setDetailName("birthday");
		if (!(Maint_XMLParserClass.q6.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q6.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q6.get(Index));


			tag ="nationality";
			sr = new Maint_DetailListItem();
			sr.setDetailName("nationality");
		if (!(Maint_XMLParserClass.q7.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q7.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q7.get(Index));


			tag ="passportnumber";
			sr = new Maint_DetailListItem();
			sr.setDetailName("passportnumber");
		if (!(Maint_XMLParserClass.q8.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q8.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q8.get(Index));
		...
		if (!(Maint_XMLParserClass.q9.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q9.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q9.get(Index));

			tag ="phonenumber2";
			sr = new Maint_DetailListItem();
			sr.setDetailName("phonenumber2");
		if (!(Maint_XMLParserClass.q10.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q10.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q10.get(Index));

			tag ="phonenumber3";
			sr = new Maint_DetailListItem();
			sr.setDetailName("phonenumber3");
		if (!(Maint_XMLParserClass.q11.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q11.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q11.get(Index));
		...
		if (!(Maint_XMLParserClass.q12.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q12.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q12.get(Index));

			tag ="residence";
			sr = new Maint_DetailListItem();
			sr.setDetailName("residence");
		if (!(Maint_XMLParserClass.q13.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q13.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q13.get(Index));


			tag ="room";
			sr = new Maint_DetailListItem();
			sr.setDetailName("room");
		if (!(Maint_XMLParserClass.q14.get(Index).equals(""))) {
			sr.setDetailValue(Maint_XMLParserClass.q14.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Maint_XMLParserClass.q14.get(Index));
...
//just test
		...
		if(hasUpdated == true) {
			...
			Maint_DetailListViewOwner.super.onBackPressed();
		}
	}
	...
	void showGooglePlayServicesAvailabilityErrorDialog(
		...
		Dialog dialog = apiAvailability.getErrorDialog(
				Maint_DetailListViewOwner.this,
			...
			if (mLastError != null) {
				if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
					...
					startActivityForResult(
							...
							Maint_DetailListViewOwner.REQUEST_AUTHORIZATION);
				} else {
