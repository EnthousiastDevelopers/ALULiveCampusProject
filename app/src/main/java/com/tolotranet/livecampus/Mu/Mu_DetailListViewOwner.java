...
public class Mu_DetailListViewOwner extends Activity
		implements EasyPermissions.PermissionCallbacks {

	ListView lv;
	Mu_DetailListViewAdapterOwner myPersonDetailListViewAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myPersonDetailListViewAdapter = new Mu_DetailListViewAdapterOwner(this,
				DetailList);
	...
	private ArrayList<Mu_DetailListItem> getPersonalDetails(int Index) {
		...
		if (!(Mu_XMLParserClass.q2.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q2.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
		DetailList.add(sr);
		map.put(tag, Mu_XMLParserClass.q2.get(Index));


			tag = "firstname";
			sr = new Mu_DetailListItem();
			sr.setDetailName(tag);
		if (!(Mu_XMLParserClass.q3.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q3.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q3.get(Index));


			tag = "lastname";
			sr = new Mu_DetailListItem();
			sr.setDetailName("lastname");
		if (!(Mu_XMLParserClass.q4.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q4.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q4.get(Index));

			tag = "fullname";
			sr = new Mu_DetailListItem();
			sr.setDetailName("fullname");
		if (!(Mu_XMLParserClass.q5.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q5.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q5.get(Index));


			tag = "birthday";
			sr = new Mu_DetailListItem();
			sr.setDetailName("birthday");
		if (!(Mu_XMLParserClass.q6.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q6.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q6.get(Index));


			tag ="nationality";
			sr = new Mu_DetailListItem();
			sr.setDetailName("nationality");
		if (!(Mu_XMLParserClass.q7.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q7.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q7.get(Index));


			tag ="passportnumber";
			sr = new Mu_DetailListItem();
			sr.setDetailName("passportnumber");
		if (!(Mu_XMLParserClass.q8.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q8.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q8.get(Index));
		...
		if (!(Mu_XMLParserClass.q9.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q9.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q9.get(Index));

			tag ="phonenumber2";
			sr = new Mu_DetailListItem();
			sr.setDetailName("phonenumber2");
		if (!(Mu_XMLParserClass.q10.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q10.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q10.get(Index));

			tag ="phonenumber3";
			sr = new Mu_DetailListItem();
			sr.setDetailName("phonenumber3");
		if (!(Mu_XMLParserClass.q11.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q11.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q11.get(Index));
		...
		if (!(Mu_XMLParserClass.q12.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q12.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q12.get(Index));

			tag ="residence";
			sr = new Mu_DetailListItem();
			sr.setDetailName("residence");
		if (!(Mu_XMLParserClass.q13.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q13.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q13.get(Index));


			tag ="room";
			sr = new Mu_DetailListItem();
			sr.setDetailName("room");
		if (!(Mu_XMLParserClass.q14.get(Index).equals(""))) {
			sr.setDetailValue(Mu_XMLParserClass.q14.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Mu_XMLParserClass.q14.get(Index));
...
//just test
		...
		if(hasUpdated == true) {
			...
			Mu_DetailListViewOwner.super.onBackPressed();
		}
	}
			...
			if (mLastError != null) {
				if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
					...
					startActivityForResult(
							...
							Mu_DetailListViewOwner.REQUEST_AUTHORIZATION);
				} else {
