...
public class Event_DetailListViewOwner extends Activity
		implements EasyPermissions.PermissionCallbacks {

	ListView lv;
	Event_DetailListViewAdapterOwner myPersonDetailListViewAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myPersonDetailListViewAdapter = new Event_DetailListViewAdapterOwner(this,
				DetailList);
	...
	private ArrayList<Event_DetailListItem> getPersonalDetails(int Index) {
		...
		if (!(Event_XMLParserClass.q2.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q2.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
		DetailList.add(sr);
		map.put(tag, Event_XMLParserClass.q2.get(Index));


			tag = "firstname";
			sr = new Event_DetailListItem();
			sr.setDetailName(tag);
		if (!(Event_XMLParserClass.q3.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q3.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q3.get(Index));


			tag = "lastname";
			sr = new Event_DetailListItem();
			sr.setDetailName("lastname");
		if (!(Event_XMLParserClass.q4.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q4.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q4.get(Index));

			tag = "fullname";
			sr = new Event_DetailListItem();
			sr.setDetailName("fullname");
		if (!(Event_XMLParserClass.q5.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q5.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q5.get(Index));


			tag = "birthday";
			sr = new Event_DetailListItem();
			sr.setDetailName("birthday");
		if (!(Event_XMLParserClass.q6.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q6.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q6.get(Index));


			tag ="nationality";
			sr = new Event_DetailListItem();
			sr.setDetailName("nationality");
		if (!(Event_XMLParserClass.q7.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q7.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q7.get(Index));


			tag ="passportnumber";
			sr = new Event_DetailListItem();
			sr.setDetailName("passportnumber");
		if (!(Event_XMLParserClass.q8.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q8.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q8.get(Index));
		...
		if (!(Event_XMLParserClass.q9.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q9.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q9.get(Index));

			tag ="phonenumber2";
			sr = new Event_DetailListItem();
			sr.setDetailName("phonenumber2");
		if (!(Event_XMLParserClass.q10.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q10.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q10.get(Index));

			tag ="phonenumber3";
			sr = new Event_DetailListItem();
			sr.setDetailName("phonenumber3");
		if (!(Event_XMLParserClass.q11.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q11.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q11.get(Index));
		...
		if (!(Event_XMLParserClass.q12.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q12.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q12.get(Index));

			tag ="residence";
			sr = new Event_DetailListItem();
			sr.setDetailName("residence");
		if (!(Event_XMLParserClass.q13.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q13.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q13.get(Index));


			tag ="room";
			sr = new Event_DetailListItem();
			sr.setDetailName("room");
		if (!(Event_XMLParserClass.q14.get(Index).equals(""))) {
			sr.setDetailValue(Event_XMLParserClass.q14.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Event_XMLParserClass.q14.get(Index));
...
//just test
		...
		if(hasUpdated == true) {
			...
			Event_DetailListViewOwner.super.onBackPressed();
		}
	}
	...
	void showGooglePlayServicesAvailabilityErrorDialog(
		...
		Dialog dialog = apiAvailability.getErrorDialog(
				Event_DetailListViewOwner.this,
			...
			if (mLastError != null) {
				if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
					...
					startActivityForResult(
							...
							Event_DetailListViewOwner.REQUEST_AUTHORIZATION);
				} else {
