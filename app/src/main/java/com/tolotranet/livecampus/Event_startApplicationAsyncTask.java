...
public class Event_startApplicationAsyncTask extends AsyncTask<Activity, Void, Void> {
	...
	protected Void doInBackground(Activity... arg0) {
		...
		File myfile = new File(Dir, "Event.txt");
	...
	protected void onPostExecute(Void result) {
		...
		if (FileExists == true) {
			...
			Intent i = new Intent();
			i.setClass(myActivity.getApplicationContext(), Event_MainList.class);
