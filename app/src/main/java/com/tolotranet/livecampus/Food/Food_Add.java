...
public class Food_Add extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calcBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkAvailable()) {
                    //normal data
                    Sign_DatabaseHelper user = new Sign_DatabaseHelper(Food_Add.this);
                    ...
                    Intent i = new Intent(Food_Add.this, Food_Confirm_Mu.class);
                    i.putExtra("cat", col6);
                    i.putExtra("pho", col3);
                    i.putExtra("des", col2);
                    i.putExtra("tit", col1);
        ...
        maintZendeskCategoryAdapter = ArrayAdapter.createFromResource(this, R.array.mu_category, R.layout.food_add_spinnerlayout);
        ...
        String category = Food_App.mu_category;
