...
public class Food_App extends AppCompatActivity {
    ...
    Food_MyCustomBaseAdapter_Select myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.food_app);
        ...
        myAdapter = new Food_MyCustomBaseAdapter_Select(getApplicationContext(),
                ContactItemArray);
...
//                        "UWallet ((Locked))", "Developer Area((Locked))", "Art&Photography((Locked))"));
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
        ...
        Intent i = new Intent(Food_App.this, Food_SpreadSheetActivity.class);
