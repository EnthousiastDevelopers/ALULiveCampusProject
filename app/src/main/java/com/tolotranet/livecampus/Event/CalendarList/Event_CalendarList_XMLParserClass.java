...
public class Event_CalendarList_XMLParserClass {
	...
	public Event_CalendarList_XMLParserClass() throws XmlPullParserException,
			IOException {
...
//		int eventType = xrp.getEventType();
		...
		String xmlString = Event_CalendarList_FileOperations.ReadData();
