...
public class Event_DetailListViewAdapter extends BaseAdapter {
	...
	public Event_DetailListViewAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.event_detail_list_item, null);
