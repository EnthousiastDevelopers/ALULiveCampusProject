...
public class Com_MyCustomBaseAdapter_Select extends BaseAdapter {
	...
	public Com_MyCustomBaseAdapter_Select(Context c, ArrayList<Booking_ItemObject> MyList) {
		this.context = c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = mInflater.inflate(R.layout.com_list_item_single, null);
