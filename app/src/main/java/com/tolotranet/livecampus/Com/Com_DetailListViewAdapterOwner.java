...
public class Com_DetailListViewAdapterOwner extends BaseAdapter {

	private static ArrayList<Com_DetailListItem> DetailList;
	private LayoutInflater mInflater;

	public Com_DetailListViewAdapterOwner(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.com_detail_list_item_owner, null);
