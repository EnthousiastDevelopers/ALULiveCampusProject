...
public class Com_App extends AppCompatActivity {
    ListView toolList;
    private FirebaseAnalytics mFirebaseAnalytics;
    ArrayList<Booking_ItemObject> ContactItemArray;
    Com_MyCustomBaseAdapter_Select myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.com_app);
        ...
        myAdapter = new Com_MyCustomBaseAdapter_Select(getApplicationContext(),
                ContactItemArray);
        toolList.setAdapter(myAdapter);

        toolList.setOnItemClickListener(new Com_App.AllContactListViewClickListener());
...
//                        "UWallet ((Locked))", "Developer Area((Locked))", "Art&Photography((Locked))"));
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
        ...
        Intent i = new Intent(Com_App.this, Com_SpreadSheetActivity.class);
