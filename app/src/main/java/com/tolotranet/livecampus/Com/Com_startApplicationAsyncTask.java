...
public class Com_startApplicationAsyncTask extends AsyncTask<Activity, Void, Void> {
	...
	protected void onPostExecute(Void result) {
		...
		if (FileExists == true) {
			...
			Intent i = new Intent();
			i.setClass(myActivity.getApplicationContext(), Com_MainList.class);
