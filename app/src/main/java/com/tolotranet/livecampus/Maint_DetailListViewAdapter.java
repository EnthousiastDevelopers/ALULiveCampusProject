...
public class Maint_DetailListViewAdapter extends BaseAdapter {
	...
	public Maint_DetailListViewAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.maint_detail_list_item, null);
