...
public class Mu_Add_Mu extends Activity {
        ...
        calcBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkAvailable()) {
                    //normal data
                    Sign_DatabaseHelper user = new Sign_DatabaseHelper(Mu_Add_Mu.this);
                    ...
                    Intent i = new Intent(Mu_Add_Mu.this, Mu_Confirm.class);
                    i.putExtra("cat", col6);
                    i.putExtra("pho", col3);
                    i.putExtra("des", col2);
                    i.putExtra("tit", col1);
