...
public class Food_DetailListViewAdapterOwner extends BaseAdapter {

	private static ArrayList<Food_DetailListItem> DetailList;
	private LayoutInflater mInflater;

	public Food_DetailListViewAdapterOwner(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.food_detail_list_item_owner, null);
