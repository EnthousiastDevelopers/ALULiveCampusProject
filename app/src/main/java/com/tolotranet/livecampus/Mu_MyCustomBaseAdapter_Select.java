...
public class Mu_MyCustomBaseAdapter_Select extends BaseAdapter {
	...
	public Mu_MyCustomBaseAdapter_Select(Context c, ArrayList<Booking_ItemObject> MyList) {
		this.context = c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = mInflater.inflate(R.layout.mu_list_item_single, null);
