...
import com.tolotranet.livecampus.Mu.Mu_Confirm;
...
public class App_Feedback extends Activity {
        ...
        calcBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkAvailable()) {
                    //normal data
                    Sign_DatabaseHelper user = new Sign_DatabaseHelper(App_Feedback.this);
                    ...
                    Intent i = new Intent(App_Feedback.this, Mu_Confirm.class);
                    i.putExtra("cat", col6);
                    i.putExtra("pho", col3);
                    i.putExtra("des", col2);
                    i.putExtra("tit", col1);
