...
public class Lead_DetailListViewOwner extends Activity
		implements EasyPermissions.PermissionCallbacks {

	ListView lv;
	Lead_DetailListViewAdapterOwner myPersonDetailListViewAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myPersonDetailListViewAdapter = new Lead_DetailListViewAdapterOwner(this,
				DetailList);
	...
	private ArrayList<Lead_DetailListItem> getPersonalDetails(int Index) {
		...
		if (!(Lead_XMLParserClass.q2.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q2.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
		DetailList.add(sr);
		map.put(tag, Lead_XMLParserClass.q2.get(Index));


			tag = "firstname";
			sr = new Lead_DetailListItem();
			sr.setDetailName(tag);
		if (!(Lead_XMLParserClass.q3.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q3.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q3.get(Index));


			tag = "lastname";
			sr = new Lead_DetailListItem();
			sr.setDetailName("lastname");
		if (!(Lead_XMLParserClass.q4.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q4.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q4.get(Index));

			tag = "fullname";
			sr = new Lead_DetailListItem();
			sr.setDetailName("fullname");
		if (!(Lead_XMLParserClass.q5.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q5.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q5.get(Index));


			tag = "birthday";
			sr = new Lead_DetailListItem();
			sr.setDetailName("birthday");
		if (!(Lead_XMLParserClass.q6.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q6.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q6.get(Index));


			tag ="nationality";
			sr = new Lead_DetailListItem();
			sr.setDetailName("nationality");
		if (!(Lead_XMLParserClass.q7.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q7.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q7.get(Index));


			tag ="passportnumber";
			sr = new Lead_DetailListItem();
			sr.setDetailName("passportnumber");
		if (!(Lead_XMLParserClass.q8.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q8.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q8.get(Index));
		...
		if (!(Lead_XMLParserClass.q9.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q9.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q9.get(Index));

			tag ="phonenumber2";
			sr = new Lead_DetailListItem();
			sr.setDetailName("phonenumber2");
		if (!(Lead_XMLParserClass.q10.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q10.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q10.get(Index));

			tag ="phonenumber3";
			sr = new Lead_DetailListItem();
			sr.setDetailName("phonenumber3");
		if (!(Lead_XMLParserClass.q11.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q11.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q11.get(Index));
		...
		if (!(Lead_XMLParserClass.q12.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q12.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q12.get(Index));

			tag ="residence";
			sr = new Lead_DetailListItem();
			sr.setDetailName("residence");
		if (!(Lead_XMLParserClass.q13.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q13.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q13.get(Index));


			tag ="room";
			sr = new Lead_DetailListItem();
			sr.setDetailName("room");
		if (!(Lead_XMLParserClass.q14.get(Index).equals(""))) {
			sr.setDetailValue(Lead_XMLParserClass.q14.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Lead_XMLParserClass.q14.get(Index));
...
//just test
		...
		if(hasUpdated == true) {
			...
			Lead_DetailListViewOwner.super.onBackPressed();
		}
	}
			...
			if (mLastError != null) {
				if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
					...
					startActivityForResult(
							...
							Lead_DetailListViewOwner.REQUEST_AUTHORIZATION);
				} else {
