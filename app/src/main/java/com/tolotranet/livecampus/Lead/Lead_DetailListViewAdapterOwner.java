...
public class Lead_DetailListViewAdapterOwner extends BaseAdapter {

	private static ArrayList<Lead_DetailListItem> DetailList;
	private LayoutInflater mInflater;

	public Lead_DetailListViewAdapterOwner(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.lead_detail_list_item_owner, null);
