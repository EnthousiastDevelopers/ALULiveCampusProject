...
public class Mu_Add_Food extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calcBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNetworkAvailable()) {
                    //normal data
                    Sign_DatabaseHelper user = new Sign_DatabaseHelper(Mu_Add_Food.this);
                    ...
                    Intent i = new Intent(Mu_Add_Food.this, Mu_Confirm.class);
                    i.putExtra("cat", col6);
                    i.putExtra("pho", col3);
                    i.putExtra("des", col2);
                    i.putExtra("tit", col1);
        ...
        maintZendeskCategory.setVisibility(View.GONE); //because we don't need a spinner, we want to focus on the food
        col6 = "Food";
        description = col6; //because description is with "Added a"+description (the point description)
    }
