...
public class Com_DetailListViewOwner extends Activity
		implements EasyPermissions.PermissionCallbacks {

	ListView lv;
	Com_DetailListViewAdapterOwner myPersonDetailListViewAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myPersonDetailListViewAdapter = new Com_DetailListViewAdapterOwner(this,
				DetailList);
	...
	private ArrayList<Com_DetailListItem> getPersonalDetails(int Index) {
		...
		if (!(Com_XMLParserClass.q2.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q2.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
		DetailList.add(sr);
		map.put(tag, Com_XMLParserClass.q2.get(Index));


			tag = "firstname";
			sr = new Com_DetailListItem();
			sr.setDetailName(tag);
		if (!(Com_XMLParserClass.q3.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q3.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q3.get(Index));


			tag = "lastname";
			sr = new Com_DetailListItem();
			sr.setDetailName("lastname");
		if (!(Com_XMLParserClass.q4.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q4.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q4.get(Index));

			tag = "fullname";
			sr = new Com_DetailListItem();
			sr.setDetailName("fullname");
		if (!(Com_XMLParserClass.q5.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q5.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q5.get(Index));


			tag = "birthday";
			sr = new Com_DetailListItem();
			sr.setDetailName("birthday");
		if (!(Com_XMLParserClass.q6.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q6.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q6.get(Index));


			tag ="nationality";
			sr = new Com_DetailListItem();
			sr.setDetailName("nationality");
		if (!(Com_XMLParserClass.q7.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q7.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q7.get(Index));


			tag ="passportnumber";
			sr = new Com_DetailListItem();
			sr.setDetailName("passportnumber");
		if (!(Com_XMLParserClass.q8.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q8.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q8.get(Index));
		...
		if (!(Com_XMLParserClass.q9.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q9.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q9.get(Index));

			tag ="phonenumber2";
			sr = new Com_DetailListItem();
			sr.setDetailName("phonenumber2");
		if (!(Com_XMLParserClass.q10.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q10.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q10.get(Index));

			tag ="phonenumber3";
			sr = new Com_DetailListItem();
			sr.setDetailName("phonenumber3");
		if (!(Com_XMLParserClass.q11.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q11.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q11.get(Index));
		...
		if (!(Com_XMLParserClass.q12.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q12.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q12.get(Index));

			tag ="residence";
			sr = new Com_DetailListItem();
			sr.setDetailName("residence");
		if (!(Com_XMLParserClass.q13.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q13.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q13.get(Index));


			tag ="room";
			sr = new Com_DetailListItem();
			sr.setDetailName("room");
		if (!(Com_XMLParserClass.q14.get(Index).equals(""))) {
			sr.setDetailValue(Com_XMLParserClass.q14.get(Index));
		}else{
			sr.setDetailValue("please updatme me! :-( ");
		}
			DetailList.add(sr);
			map.put(tag, Com_XMLParserClass.q14.get(Index));
...
//just test
		...
		if(hasUpdated == true) {
			...
			Com_DetailListViewOwner.super.onBackPressed();
		}
	}
			...
			if (mLastError != null) {
				if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
					...
					startActivityForResult(
							...
							Com_DetailListViewOwner.REQUEST_AUTHORIZATION);
				} else {
