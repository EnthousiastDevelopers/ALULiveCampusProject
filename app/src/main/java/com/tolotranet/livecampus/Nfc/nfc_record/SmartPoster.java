 ...
 */
package com.tolotranet.livecampus.Nfc.nfc_record;
...
import com.tolotranet.livecampus.Nfc.Nfc_NdefMessageParser;
...
public class SmartPoster implements ParsedNdefRecord {
    ...
    public static SmartPoster parse(NdefRecord[] recordsRaw) {
        try {
            List<ParsedNdefRecord> records = Nfc_NdefMessageParser.getRecords(recordsRaw);
